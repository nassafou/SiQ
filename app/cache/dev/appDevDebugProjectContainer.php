...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'siq_support.antispam' => 'getSiqSupport_AntispamService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'dbtickets', 'user' => 'root', 'password' => 'Pa$$w0rd1', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_de9dd9904ac7655d90bfbdf6bcb7b548');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_de9dd9904ac7655d90bfbdf6bcb7b548');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_de9dd9904ac7655d90bfbdf6bcb7b548');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/SiQ/SupportBundle/Entity'))), 'SiQ\\SupportBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SupportBundle' => 'SiQ\\SupportBundle\\Entity'));
    ...
    /**
     * Gets the 'siq_support.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SiQ\SupportBundle\Antispam\TicketAntispam A SiQ\SupportBundle\Antispam\TicketAntispam instance.
     */
    protected function getSiqSupport_AntispamService()
    {
        return $this->services['siq_support.antispam'] = new \SiQ\SupportBundle\Antispam\TicketAntispam();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SiQ/SupportBundle/Resources/views'), 'Support');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SupportBundle' => 'SiQ\\SupportBundle\\SupportBundle',
